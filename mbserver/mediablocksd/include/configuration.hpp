 ...
 *
 * @brief The Configuration class represents the configuration of the device in an JSON document
 *
 * The Confuguration class represents the entire JSON document.
 * It provides the primary access to each of the elements of the configuration:
 *
 *
 * @code
{
	"devicename": "MediaBlocks",
	"local": {
		"enbale": true,
		"library": "sqlite",
 ...
 * @endcode
 *
 * @sa MediaBlocks::Test::_Configuration for the testing class.
 */
...
signals:
	//// begin signals
	/**
	 * @brief Configuration changed signal
	 *
	 * This signal is emitted, when the configuration of the device was changed successfully.
	 */
	void changed();
	//// end signals
};
