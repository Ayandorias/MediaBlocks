#ifndef MEDIABLOCKS_GLOBAL_H
#define MEDIABLOCKS_GLOBAL_H

#include <QtCore/qglobal.h>

#if defined(MEDIABLOCKS_LIBRARY)
#  define MEDIABLOCKSSHARED_EXPORT Q_DECL_EXPORT
#else
#  define MEDIABLOCKSSHARED_EXPORT Q_DECL_IMPORT
#endif
